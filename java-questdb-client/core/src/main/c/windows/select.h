 ...
 * Signature: (JJJ)I
 */
JNIEXPORT jint JNICALL Java_io_questdb_client_net_Win32SelectDispatcher_select
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_io_questdb_client_net_Win32SelectDispatcher_countOffset
        (JNIEnv *, jclass);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_io_questdb_client_net_Win32SelectDispatcher_arrayOffset
        (JNIEnv *, jclass);
